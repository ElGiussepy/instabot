...
(async () => {
  ...
  try {
    ...
    const usersToFollowFollowersOf = ['culturarosario'];

//'beatsandcurves', 'tinawh0', 'carrylight_official_'yinyleonofficial
